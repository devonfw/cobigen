...
[arabic]
Once done, right click on EmployeeEto.java file present under the package _com.devonfw.poc.employeemanagement.logic.api.to_, in the Back End part (_mayapp-core_ module).
