...
If you are using a backend server with `JWT` authentication, you need to set the Angular application to use this type of authentication. By default, this is the case if you use the devon4ng template.
