...
*Updated:* This explains the manual process of releasing. We now have an automatic script that enables a fast and easy release. Please check it link:https://github.com/devonfw/tools-cobigen/wiki/howto_Release-creation[here]
