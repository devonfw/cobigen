...
Now you need to convert the _CobiGen_Templates_ project to a Maven project, for doing so right-click the project -> Configure -> Convert to Maven project.

image:images/howtos/ide-setup/22_convert_to_maven_project.png[]

Finally, please change the Java version of the project to 1.8 so that you don't have any compilers.
