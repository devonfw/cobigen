...
In order to test the server, you will have to deploy it on your local machine (localhost) and port 5000. If that port is already in use, you can deploy it on higher port values (5001, 5002...). Nevertheless, we explain <<testing_phase, later>> the testing process as you need to complete the next step before.
