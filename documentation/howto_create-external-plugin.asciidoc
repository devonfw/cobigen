...
+
b. Now you can run any CobiGen CLI commands using a console. link:https://github.com/devonfw/tools-cobigen/wiki/howto_Cobigen-CLI-generation[This guide] explains all the CLI commands.
+
