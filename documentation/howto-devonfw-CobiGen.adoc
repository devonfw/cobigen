...
Configure one of the below security rules.

* https://devonfw.com/website/pages/docs/devon4j.asciidoc_guides.html#guide-csrf.asciidoc[CSRF]
* https://devonfw.com/website/pages/docs/devon4j.asciidoc_guides.html#guide-jwt.asciidoc[JWT]
