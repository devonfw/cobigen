...
public class MultipleMatchingTriggerTest extends SystemTest {
    ...
    /**
     * Tests correct generation in case of a destination paths matches multiple templates of different
     * matching trigger.
     * @throws Exception
     *             Test fails
     */
    ...
    public void testMutlipleTemplates_differentTrigger_samePath() throws Exception {
        ...
        try (InputStream in = generationResult.getContents()) {
            ...
            assertThat(fileContents).isIn("Increment1TemplateIncrement2Template",
                "Increment2TemplateIncrement1Template");
        }
    }
