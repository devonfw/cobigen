...
public class Retry {
   ...
   * @param <E> the exception type to retry for
   * @param callable the function to execute
   * @param retryException the class object for the exception to be retried
   * @param retries the number of max retries
   * @return the result of the callable
   * @throws Exception in case another exception occurred different to the retryException or even if after the given
   *         number of retries no result could be returned without exception.
   */
