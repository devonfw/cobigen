...
public class JavaGeneratorWrapper {
    ...
    private CobiGen initializeGenerator() throws GeneratorProjectNotExistentException, CoreException,
            UnknownExpressionException, UnknownContextVariableException, IOException, InvalidConfigurationException {
    ...
    public void setInputPackage(IPackageFragment packageFragment) {
        ...
        this.pojo = null;
        packageFolder =
                new PackageFolder(packageFragment.getResource().getLocationURI(), packageFragment.getElementName());
    ...
    public List<String> getMatchingTriggerIds() {
        ...
        if (packageFolder != null)
            ...
            return cobiGen.getMatchingTriggerIds(pojo);
    }
    ...
    public Map<String, String> getAttributesToTypeMap() throws InvalidConfigurationException {
        ...
        List<String> matchingTriggerIds = cobiGen.getMatchingTriggerIds(pojo);
        Map<String, Object> model = cobiGen.getModelBuilder(pojo, matchingTriggerIds.get(0)).createModel();
