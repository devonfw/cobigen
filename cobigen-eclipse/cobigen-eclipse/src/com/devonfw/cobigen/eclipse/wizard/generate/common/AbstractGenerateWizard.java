...
public abstract class AbstractGenerateWizard extends Wizard {
   ...
   *
   * @param generator {@link CobiGenWrapper generator} to be used for generation
   * @param monitor to track any progress
   */
  public AbstractGenerateWizard(CobiGenWrapper generator, IProgressMonitor monitor) {

    this.cobigenWrapper = generator;
  ...
  private boolean userConfirmed() {
    ...
    while (it.hasNext()) {
      Object r = it.next();
      if (r instanceof IResourceStub || r instanceof IJavaElementStub || (r instanceof OffWorkspaceResourceTreeNode
