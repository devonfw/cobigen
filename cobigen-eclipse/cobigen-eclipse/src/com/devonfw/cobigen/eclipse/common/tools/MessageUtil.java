...
public class MessageUtil {
  ...
  /**
   * @param s the String that contains the previous error message
   * @param report the {@link HealthCheckReport} to be addressed by this method.
   * @return a new enriched String if more than one error occurred while running the HealthCheck, otherwise just returns
   *         the input String.
   */
