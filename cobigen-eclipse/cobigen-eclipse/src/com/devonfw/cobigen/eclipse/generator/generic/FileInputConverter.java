...
public class FileInputConverter {
  ...
  /**
   * Converts the eclipse internal resources selected to valid xml input types to be used for generation using CobiGen
   *
   * @param cobigen initialized {@link CobiGen} instance
   * @param resources {@link List} of eclipse internal resources selected as input
  ...
  private static Object convertFile(CobiGen cobigen, IFile inputFile) throws GeneratorCreationException {
    ...
    try {
      ...
      throw new GeneratorCreationException(
          "Could not read file " + inputFile.getLocationURI() + " as no Plug-in for the given type could be found.", e);
    }
