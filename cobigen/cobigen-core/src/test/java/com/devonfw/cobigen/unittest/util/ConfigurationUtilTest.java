...
public class ConfigurationUtilTest {
  ...
  public void testFindTemplatesLocation() throws Exception {
    ...
    restoreSystemProperties(() -> {
      ...
      File userHome = this.tmpFolder.newFolder(".cobigen");
      withEnvironmentVariable(ConfigurationConstants.CONFIG_ENV_HOME, userHome.toString()).execute(() -> {
        // configuration file found from environment variable
        Path defaultCobigenHome = CobiGenPaths.getCobiGenHomePath();
