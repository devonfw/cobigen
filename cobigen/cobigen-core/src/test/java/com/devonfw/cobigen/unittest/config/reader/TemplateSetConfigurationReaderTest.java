...
public class TemplateSetConfigurationReaderTest extends AbstractUnitTest {
  ...
  public void testInvalidTemplateSets() throws InvalidConfigurationException {
    ...
    try {
      new TemplateSetConfigurationDecorator(new ArrayList<String>(), true, new ArrayList<String>(), INVALID_CONFIGURATION_PATH);
    } catch (InvalidConfigurationException ice) {
  ...
  public void testTemplateSetsDownloaded() {
    ...
    TemplateSetConfigurationDecorator testConfiguration = new TemplateSetConfigurationDecorator(new ArrayList<String>(), true,
        new ArrayList<String>(), templateSetPath);

    TemplateSetConfigurationReader testReader = new TemplateSetConfigurationReader(templateSetPath, testConfiguration);
    assertThat(testConfiguration.getTemplateSetFiles().size()).isEqualTo(1);
  }
  ...
  //
  // // when
  // Map<String, Template> templates = templateSet.loadTemplates();
  //
  // // then
  ...
  //
  // // given
  // TemplateSetConfigurationReader target = new TemplateSetConfigurationReader(validConfigurationPath);
  //
  // // when
  ...
  // */
  // @Test(expected = InvalidConfigurationException.class)
  // public void testErrorOnInvalidConfiguration1() throws InvalidConfigurationException {
  //
  ...
  //
  // com.devonfw.cobigen.impl.config.reader.interfaces.TemplatesConfigurationInterface reader = new
  // TemplatesConfigurationReader(
  ...
  //
  // /**
  // * Tests whether a two equally named files will result in an {@link InvalidConfigurationException} if they are
  // scanned
  ...
  //
  // // given
  // TemplateSetConfigurationReader reader = new TemplateSetConfigurationReader(validConfigurationPath);
  //
  // Trigger trigger = new Trigger("", "asdf", "", Charset.forName("UTF-8"), new LinkedList<Matcher>(),
  // new LinkedList<ContainerMatcher>());
  //
  // // when
  // Map<String, Template> templates = reader.loadTemplates();
  ...
  //
  // // given
  // com.devonfw.cobigen.impl.config.reader.interfaces.TemplatesConfigurationInterface target = new
  // TemplatesConfigurationReader(
  ...
  //
  // /**
  // * Test for <a href="https://github.com/devonfw/cobigen/issues/167">Issue 167</a>. Tests if the exception message
  // from
  // * {@link #testErrorOnDuplicateScannedIds()} contains the name of the file causing the exception
  // */
  // @Test
  ...
  //
  // /**
  // * Tests an overlapping configuration according to the destination paths of a relocated folder within a template
  // scan
  // * and a explicitly defined destination path of a template configuration XML node. The destination path of a
  // template
  ...
  // return template;
  // }
  // TODO: That should be tested in the cobigen factory
  // /**
