...
public class ConfigurationFinderTest {
    ...
    public void testFindTemplatesLocation_WithoutExistingFolders() throws Exception {
        ...
        assertThat(Paths.get(templateSets).getFileName().toString()).isEqualTo(ConfigurationConstants.TEMPLATE_SETS_FOLDER);
    }
    ...
    public void testFindTemplateLocation_WithIvalidTemplateSetPropertySet() throws Exception {
        ...
        CobiGenPaths.setCobiGenHomeTestPath(userHome.toPath());
        URI templates = ConfigurationFinder.findTemplatesLocation();
        Path actual = Paths.get(templates);
        assertThat(actual).exists();
        assertThat(actual).isEqualTo(userHome.toPath().resolve(ConfigurationConstants.TEMPLATE_SETS_FOLDER));
    }
