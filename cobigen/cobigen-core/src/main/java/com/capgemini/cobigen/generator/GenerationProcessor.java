...
import com.capgemini.cobigen.extension.to.GenerableArtifact;
import com.capgemini.cobigen.extension.to.GenerationReportTo;
...
public class GenerationProcessor {
     ...
     */
    private void generate(Object matchingInput, TemplateTo template, ITriggerInterpreter triggerInterpreter,
        ...
        for (Object generatorInput : inputObjects) {
            ...
            ModelBuilder modelBuilder = new ModelBuilder(generatorInput, trigger, matchingInput);
            Map<String, Object> model = modelBuilder.createModel(triggerInterpreter);
            if (logicClasses != null) {
                modelBuilder.enrichByLogicBeans(model, logicClasses);
            }
     ...
     *            object
     * @param triggerInterpreter
     *            {@link ITriggerInterpreter} to be used
     * @param trigger
     *            {@link Trigger} to be used
     * @return the {@link List} of collected input objects.
     */
    private List<Object> collectInputObjects(Object input, ITriggerInterpreter triggerInterpreter,
        Trigger trigger) {
