...
public class ContextConfigurationReader {
     ...
     *
     * @param trigger
     *            {@link com.capgemini.cobigen.impl.config.entity.io.Trigger} to retrieve the {@link Matcher}s from
    ...
    /**
     * Loads all {@link ContainerMatcher}s of a given {@link com.capgemini.cobigen.impl.config.entity.io.Trigger}
     *
     * @param trigger
     *            {@link com.capgemini.cobigen.impl.config.entity.io.Trigger} to retrieve the {@link Matcher}s from
     * @return the {@link List} of {@link Matcher}s
     ...
     * @author mbrunnli (08.04.2014)
     */
    private List<VariableAssignment> loadVariableAssignments(com.capgemini.cobigen.impl.config.entity.io.Matcher matcher) {
