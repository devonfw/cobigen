...
public class PluginRegistry {
    ...
    public static <T extends IGeneratorPluginActivator> void loadPlugin(Class<T> generatorPlugin) {
        try {
            ...
            if (plugin instanceof IGeneratorPluginActivator) {
                // Collect IMerger
                // TODO validation if there are null references within the
                // getters of the Interfaces
            ...
            LOG.error("{}", "Instation Exception", e);
     ...
     * @author mbrunnli (07.04.2014)
     */
    // TODO throw exception if already registered
