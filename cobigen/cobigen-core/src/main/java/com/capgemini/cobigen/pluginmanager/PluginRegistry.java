...
public class PluginRegistry {
     ...
     */
    private static Map<String, ITriggerInterpreter> registeredTriggerInterpreter = Collections.synchronizedMap(Maps
            .<String, ITriggerInterpreter> newHashMap());
    ...
    /***
     * Loads the given plug-in and registers all {@link IMerger}s and {@link ITriggerInterpreter}s bound by the given
     * plug-in
     * 
    ...
    public static <T extends IGeneratorPluginActivator> void loadPlugin(Class<T> generatorPlugin) {
        ...
        try {
            ...
            LOG.error("Could not intantiate Generator Plug-in '{}'", generatorPlugin.getClass().getCanonicalName(), e);
        }
    }
    ...
    public static void registerTriggerInterpreter(ITriggerInterpreter triggerInterpreter) {
        ...
        LOG.info("TriggerInterpreter for type '{}' registered ({})", triggerInterpreter.getType(), triggerInterpreter
     ...
     * 
     * @param mergerType the {@link IMerger} should be able to interpret
     * @return the {@link IMerger} for the given mergerType or <code>null</code> if there is no {@link IMerger} for this
     *         mergerType
     * @author mbrunnli (07.04.2014)
     */
     ...
     * 
     * @param triggerType the {@link ITriggerInterpreter} should be able to interpret
