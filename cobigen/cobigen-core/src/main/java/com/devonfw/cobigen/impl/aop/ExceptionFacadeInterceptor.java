...
/**
 * This is the interceptor processing {@link ExceptionFacade} annotations. It wraps each return value with a try catch
 * block forwarding exceptions of type {@link CobiGenRuntimeException} and wrapping any other exception into a
 * {@link PluginProcessingException}.
 */
