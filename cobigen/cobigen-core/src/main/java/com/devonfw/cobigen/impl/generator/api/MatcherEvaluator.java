...
public interface MatcherEvaluator {
  ...
  /**
   * Checks whether the list of matches matches the matcher input according to the given trigger interpreter.
   *
   * @param matcherInput input for the matcher
   * @param matcherList list of matchers to be checked
   * @param triggerInterpreter to called for checking retrieving the matchers matching result
