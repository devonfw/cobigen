...
public abstract class TemplatePath {
  ...
  /**
   * @return the physical {@link Path} pointing to the actual {@link TemplateFolder} or {@link TemplateFile}.
   */
  ...
  /**
   * @return the parent {@link TemplateFolder} or <code>null</code> if this is the root (top-level folder of the
  ...
  /**
   * @return {@code true} if this is a {@link TemplateFolder}, {@code false} in case of a {@link TemplateFile}.
   */
  public abstract boolean isFolder();

  /**
   * @return {@code true} if this is a {@link TemplateFile}, {@code false} in case of a {@link TemplateFolder}.
   */
