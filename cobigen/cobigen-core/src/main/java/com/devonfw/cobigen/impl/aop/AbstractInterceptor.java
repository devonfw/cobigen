...
/**
 * The {@link AbstractInterceptor} provides the ability of holding the target object for any {@link InvocationHandler}
 * implementation implementing the {@link AbstractInterceptor}.
 */
public abstract class AbstractInterceptor implements InvocationHandler {
   ...
   *
   * @param target method to check for annotation activation
   * @param annotationClass type of annotation to be looked for
