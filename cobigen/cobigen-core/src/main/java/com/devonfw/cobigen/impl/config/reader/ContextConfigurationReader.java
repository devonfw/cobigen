...
public class ContextConfigurationReader {
    ...
    public Map<String, Trigger> loadTriggers() {
        ...
        for (com.devonfw.cobigen.impl.config.entity.io.Trigger t : contextNode.getTrigger()) {
     ...
     *
     * @param trigger
     *            {@link com.devonfw.cobigen.impl.config.entity.io.Trigger} to retrieve the {@link Matcher}s
     *            from
     ...
     * {@link com.devonfw.cobigen.impl.config.entity.io.Trigger}
     *
     * @param trigger
     *            {@link com.devonfw.cobigen.impl.config.entity.io.Trigger} to retrieve the {@link Matcher}s
     *            from
     ...
     * {@link com.devonfw.cobigen.impl.config.entity.io.Matcher}
     *
     * @param matcher
     *            {@link com.devonfw.cobigen.impl.config.entity.io.Matcher} to retrieve the
