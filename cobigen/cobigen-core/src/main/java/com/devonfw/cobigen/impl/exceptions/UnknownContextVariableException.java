...
/**
 * The {@link UnknownContextVariableException} occurs a context variable is used, which is unknown by xsd definition
 */
public class UnknownContextVariableException extends InvalidConfigurationException {
   ...
   *
   * @param variableName name of the unknown variable
   */
