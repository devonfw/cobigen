...
var patchOverride = process.argv[2];
var base = process.argv[3];
var patch = process.argv[4];

merge(patchOverride, base, patch);
...
function merge(patchOverrides, fileBase, filePatch) {
    ...
    var sourceFilePatch = ts.createSourceFile(filePatch, filePatch, ts.ScriptTarget.ES2016, true, ts.SyntaxKind[256]);
    var result = [];
