...
import com.capgemini.cobigen.jsonplugin.inputreader.to.PackageFolder;
import com.capgemini.cobigen.jsonplugin.merger.libextension.ModifyableClassLibraryBuilder;
import com.capgemini.cobigen.jsonplugin.util.freemarkerutil.IsAbstractMethod;
import com.capgemini.cobigen.jsonplugin.util.freemarkerutil.IsSubtypeOfMethod;
...
public class JSONInputReader implements InputReader {
     ...
     * Logger instance
     */
    private static final Logger LOG = LoggerFactory.getLogger(JSONInputReader.class);
