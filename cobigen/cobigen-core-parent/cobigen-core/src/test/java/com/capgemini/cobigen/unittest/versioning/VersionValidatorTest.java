package com.capgemini.cobigen.unittest.versioning;
...
public class VersionValidatorTest {
    ...
    /**
     * Testing the CobiGen version to be too old for the provided configuration version, which indicates to
     * make an update of CobiGen to read the configuration properly.
     * @author mbrunnli (May 17, 2016)
     */
    ...
    public void testInvalidCobiGenVersion_tooOld_contextConfiguration() {
        ...
        try {
            ...
            assertThat(e.getMessage())
                .matches(".* version '2.1' .* context configuration is unknown .* CobiGen '2.0'.*");
            throw e;
        }
    }

    /**
     * Testing the CobiGen version to be too new for the provided configuration version, which indicates to
     * make an update of the configuration to read it properly.
     * @author mbrunnli (May 17, 2016)
     */
    @Test(expected = InvalidConfigurationException.class)
