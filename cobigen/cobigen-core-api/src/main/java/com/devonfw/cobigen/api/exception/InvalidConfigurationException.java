...
public class InvalidConfigurationException extends CobiGenRuntimeException {
   ...
   *
   * @param filePath file path causing the InvalidConfigurationException or null if not available
   ...
   * Creates a new {@link InvalidConfigurationException} with the given message
   *
   * @param filePath {@link Path} file path causing the InvalidConfigurationException or null if not available
   * @param msg error message of the exception
   * @param t cause exception
   */
