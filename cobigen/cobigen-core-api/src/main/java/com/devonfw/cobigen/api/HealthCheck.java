...
public interface HealthCheck {
   ...
   *
   * @param contextConfiguration the path to the context configuration file
   ...
   *
   * @param templatesConfigurationFolder the path to the templates configuration
   * @param backupPolicy the {@link BackupPolicy} that should be used for the function
   * @return the {@link HealthCheckReport} of this HealthCheck
   */
  ...
  /**
   * Upgrades both the context configuration and the templates configuration. For future usage in other plug-ins.
   *
   * @param configurationPath the path in which the files are that should be upgraded. Further changes of the path might
   ...
   *
   * @param configurationPath the path in which the files are that should be checked regarding their version and
