...
/**
 * Priorities an input reader is ranked with in case {@link InputReader#isMostLikelyReadable(java.nio.file.Path)} is
 * returning true for multiple plug-ins available.
 */
