...
public class IncrementTo extends GenerableArtifact {
   ...
   * @param templates a {@link List} of {@link TemplateTo}s which are part of the increment (recursively resolved)
   * @param dependentIncrements a {@link List} of dependent increments which are part of this increment
   */
