...
public class ExceptionUtil {
  ...
  /**
   * Tries to find the exception with the given type in the causing stack trace of exceptions of the given exception
   * <code>e</code>
   *
   * @param <T> type of the throwable to be found in the exception's stack trace
   *
   * @param e super exception to retrieve the causes stack from
   * @param cause {@link Class} which should be found and retrieved
   ...
   *
   * @param e super exception to retrieve the causes stack from
   * @param causes {@link Class}es which should be found and retrieved in sorted with a decreasing priority to be found.
   * @return the cause with the given type if found<br>
   *         otherwise <code>null</code>
   */
   ...
   *
   * @param targetObject target object to invoke the method on
