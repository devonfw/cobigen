...
/**
 * Used as a container for the source code text. We need it for sending the content to our server, so that the code gets
 * beautified
 */
public class InputFileTo {
   ...
   *
   * @param filename name of file including its extension
   * @param content string content of the file
   * @param charset which charset needs to be used when reading the file
   */
  ...
  /**
   * @param content set file content
   */
