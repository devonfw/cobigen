...
mvn org.codehaus.mojo:license-maven-plugin:2.0.0:aggregate-download-licenses -Dlicense.artifactFiltersUrl=$filter_file -P!p2-build -Dsettings.offline=true -Dlicense.includeOptional=false -Dlicense.includedScopes=compile,runtime
cd ../..
cd cobigen-cli/cli
mvn org.codehaus.mojo:license-maven-plugin:2.0.0:aggregate-download-licenses -Dlicense.artifactFiltersUrl=$filter_file -P!p2-build -Dsettings.offline=true -Dlicense.includeOptional=false -Dlicense.includedScopes=compile,runtime
cd ../..
