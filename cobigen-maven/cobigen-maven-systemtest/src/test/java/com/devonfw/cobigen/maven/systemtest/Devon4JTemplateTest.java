...
public class Devon4JTemplateTest extends AbstractMavenTest {
  ...
  public void testEntityInputDataaccessGeneration() throws Exception {
    ...
    File testTemplates = new File(TEST_RESOURCES_ROOT + "templates-devon4j/");
    File testProjectRoot = runMavenInvoker(testProject, testTemplates, MavenMetadata.LOCAL_REPO);
