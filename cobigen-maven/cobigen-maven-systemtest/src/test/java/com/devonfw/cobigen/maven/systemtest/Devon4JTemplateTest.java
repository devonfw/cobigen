 ...
 *
 */
public class Devon4JTemplateTest extends AbstractMavenTest {
    ...
    /**
     * Processes a generation of devon4j template increment tos and just checks whether the files have been
     * generated. Takes an entity (POJO) as input.
     * @throws Exception
     *             test fails
     */
    @Test
    ...
    /**
     * Processes a generation of devon4j template increments tos and just checks whether the files have been
     * generated. Takes an entity (POJO) as input. <br/>
     * This is the same test as {@link #testEntityInputDataaccessGeneration()} but using the devon4j templates
     * version 3.1.8. Those templates use Java classes that need to be loaded by the maven plugin
     * @throws Exception
     *             test fails
     */
    @Test
    ...
    /**
     * Processes a generation of devon4j template increments tos and entity_infrastructure and just checks
     ...
     * of devon4j template increments daos, entity_infrastructure, TOs, Logic and Rest Service and just checks
