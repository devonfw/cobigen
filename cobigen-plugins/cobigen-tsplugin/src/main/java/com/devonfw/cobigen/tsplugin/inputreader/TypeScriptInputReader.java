...
public class TypeScriptInputReader extends ExternalServerInputReaderProxy {
   ...
   *
   * @param externalProcess the external process instance to communicate with.
   */
  ...
  public List<Object> getInputObjects(Object input, Charset inputCharset, boolean recursively) {
    ...
    if (isValidInput(input)) {
      ...
      Map<String, Object> inputModel = (Map<String, Object>) read(new File(input.toString()).toPath(), inputCharset);
   ...
   *
   * @param mapModel map where our object to cast is stored
   * @param key cast object with this key
   ...
   *
   * @param o object to cast to linked hash map
