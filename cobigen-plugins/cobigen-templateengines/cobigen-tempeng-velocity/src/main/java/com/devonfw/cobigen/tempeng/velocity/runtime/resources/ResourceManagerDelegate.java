...
/**
 * This class tries to tackle the recurring 'ResourceManagerImpl doesn't implement ResourceManager' error. It is a
 * simple delegate to the a ResourceManagerImpl instance implementing the ResourceManager interface
 */
public class ResourceManagerDelegate implements ResourceManager {
  ...
  public String getLoaderNameForResource(String arg0) {
    ...
    return this.manager.getLoaderNameForResource(arg0);
  }
  ...
  public Resource getResource(String arg0, int arg1, String arg2)
    ...
    return this.manager.getResource(arg0, arg1, arg2);
  }

  @Override
  public void initialize(RuntimeServices arg0) {

    this.manager.initialize(arg0);
  }
