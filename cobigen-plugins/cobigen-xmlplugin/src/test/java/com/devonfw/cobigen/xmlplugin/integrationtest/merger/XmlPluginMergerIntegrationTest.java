...
public class XmlPluginMergerIntegrationTest {
  ...
  public void mergeDoesNotDestroySchemaLocation() throws Exception {
    ...
    String basePath = this.resourcesRoot + "BaseFile_namespaces.xml";

    File baseFile = new File(basePath);
    String patchString = readFile(basePath, this.charset);
    String mergedString = this.basePreferingMerger.merge(baseFile, patchString, this.charset);
...
>>>>>>> fbcd15c62d3cc027fdcb6cfca7268c708eae9032
   *
   * @throws Exception test fails
   */
  @Test
  public void testMergeAlsoMergesSchemaLocations() throws Exception {
    ...
    String basePath = this.resourcesRoot + "BaseFile_namespaces.xml";
    String patchPath = this.resourcesRoot + "PatchFile_namespaces.xml";

    File baseFile = new File(basePath);
    String patchString = readFile(patchPath, this.charset);
    String mergedDoc = this.basePreferingMerger.merge(baseFile, patchString, this.charset);
  ...
  public void webFlowTest() throws Exception {
    ...
    String basePath = this.resourcesRoot + "BaseFile_flow.xml";
    String patchPath = this.resourcesRoot + "PatchFile_flow.xml";
    ...
    Assert.assertEquals(3,
        ((Element) mergeDoc.getElementsByTagName("view-state").item(0)).getElementsByTagName("transition").getLength());
  ...
  public void xhtmlTest() throws Exception {
    ...
    String basePath = this.resourcesRoot + "BaseFile_overview.xhtml";
    String patchPath = this.resourcesRoot + "PatchFile_overview.xhtml";
    ...
    Assert.assertEquals(1,
        ((Element) mergeDoc.getElementsByTagName("ui:define").item(0)).getElementsByTagName("ui:include").getLength());
    Assert.assertEquals(1,
        ((Element) mergeDoc.getElementsByTagName("ui:define").item(2)).getElementsByTagName("ui:include").getLength());
    Assert.assertEquals(1,
        ((Element) mergeDoc.getElementsByTagName("ui:define").item(3)).getElementsByTagName("ui:include").getLength());
  }
  ...
  public void queryTest() throws Exception {
    ...
    String basePath = this.resourcesRoot + "BaseFile_queries.xml";
    String patchPath = this.resourcesRoot + "PatchFile_queries.xml";
  ...
  public void xhtmlTableTest() throws Exception {
    ...
    String basePath = this.resourcesRoot + "BaseFile_table.xhtml";
    String patchPath = this.resourcesRoot + "PatchFile_table.xhtml";
  ...
  public void testMergeDozerMapping() throws Exception {
    ...
    String basePath = this.resourcesRoot + "BaseFile_OneOneNine_dozer.xml";
    String patchPath = this.resourcesRoot + "PatchFile_OneOneNine_dozer.xml";
  ...
  public void testMergeJaxrsServiceBeans() throws Exception {
    ...
    String basePath = this.resourcesRoot + "BaseFile_OneOneNine.xml";
    String patchPath = this.resourcesRoot + "PatchFile_OneOneNine.xml";
  ...
  /**
   * Tests the correct merge behavior with Spring Beans. Test files are used from XmlLawMerger test resources
   *
  ...
  public void testBeans() throws Exception {
    ...
    String basePath = this.resourcesRoot + "BaseFile_beans.xml";
    String patchPath = this.resourcesRoot + "PatchFile_beans.xml";
  ...
  public void testValidationEnabledThrowsMergeException() throws Exception {
    ...
    this.patchPreferingMerger = new XmlMergerDelegate(mergeSchemaLocation, MergeType.PATCHATTACHOROVERWRITEVALIDATE,
        true);
    this.basePreferingMerger = new XmlMergerDelegate(mergeSchemaLocation, MergeType.BASEATTACHOROVERWRITEVALIDATE,
        true);
  ...
  public void testMavenAddDependency() throws Exception {
    ...
    String basePath = this.resourcesRoot + "BasePom.xml";
    String patchPath = this.resourcesRoot + "PatchPom.xml";
    File baseFile = new File(basePath);
    String patchString = readFile(patchPath, this.charset);
    String mergedDoc = this.patchPreferingMerger.merge(baseFile, patchString, this.charset);
    assertEquals("Not the expected number of dependencies elements", 1, mergedDoc.split("<dependencies").length - 1);
   ...
   * @param charset String name of the used charset
   * @return String
