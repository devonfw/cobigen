...
public class ModelConstant {
  ...
  /**
   * prefix for a single attribute. An attribute will be represented by mapping from the attribute's name to its value
   * ({@link Map}&lt;{@link String}, {@link Object}&gt;)
   */
  public static final String SINGLE_ATTRIBUTE = "_at_";

  /**
   * A list of all attributes. Each of the SINGLE_ATTRIBUTEs will be provided here as a reference ( {@link List}&lt;
   * {@link Map}&lt;{@link String}, {@link Object} &gt;&gt;).
   */
  ...
  /**
   * prefix for a single child node. An child node will be represented by mapping from the child's name to its model
   * ({@link Map}&lt;{@link String}, {@link Object}&gt;). If two ore more children have the same name they will not
   * provided here as SINGLE_CHILD, but in the list CHILDREN, like all die other children.
   */
  public static final String SINGLE_CHILD = "";

  /**
   * A list of all children. In addition to the SINGLE_CHILDren also the children which do not have an unique name will
   * be provided here ( {@link List}&lt; {@link Map}&lt;{@link String}, {@link Object} &gt;&gt;).
   */
