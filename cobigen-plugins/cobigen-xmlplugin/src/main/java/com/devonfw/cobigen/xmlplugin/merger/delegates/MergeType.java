...
public enum MergeType {
  ...
  /**
   * In case of a conflict the base document is preferred. Attributes and text nodes will be attached where possible
   */
  BASEATTACHOROVERWRITE("xmlmerge_attachTexts", ConflictHandlingType.BASEATTACHOROVERWRITE),
  /**
   * In case of a conflict the patch document is preferred. Attributes and text nodes will be attached where possible
   */
