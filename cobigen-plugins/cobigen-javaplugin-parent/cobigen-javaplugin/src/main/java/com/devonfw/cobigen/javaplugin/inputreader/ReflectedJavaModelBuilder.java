...
/**
 * The {@link ReflectedJavaModelBuilder} creates a new model for a given input
 * pojo class
 */
public class ReflectedJavaModelBuilder {
     ...
     *
     * @param pojo {@link Class} object of the pojo all information should be
     *             retrieved from
     * @return A {@link Map} of a {@link String} key to {@link Object} mapping keys
     *         as described before to the
     *         corresponding information. Learn more about the FreeMarker data model
     *         at http
    ...
    /**
     * Extracts all fields from the given pojo, which are visible by using setter
     * and getter methods
     *
     * @param pojo source {@link Class} to determine all fields accessible via
     *             methods from
     * @return a list of field properties equivalently to
     *         {@link #extractFields(Class)}
     */
     ...
     *
     * @param pojo {@link Class} object of the POJO the data should be retrieved
     *             from
     * @return a {@link Set} of attributes, where each attribute is represented by a
     *         {@link Map} of a {@link String} key
     ...
     *
     * @param pojo {@link Class} object of the POJO the super type should be
     *             retrieved from
     * @return the super type, represented by a {@link Map} of a {@link String} key
     *         to the corresponding {@link String}
     *         value of meta information or {@code null} if there is no super class
     *         (e.g. for interfaces)
     */
     ...
     *
     * @param pojo {@link Class} object of the POJO the interfaces should be
     *             retrieved from
     * @return a {@link Set} of implementedTypes (interfaces), where each is
     *         represented by a {@link Map} of a
     *         {@link String} key to the corresponding {@link String} value of meta
     *         information
     */
    ...
    /**
     * Collect all annotations for the given pojo from setter and getter methods by
     * searching using the attribute names.
     * Annotation information retrieved from the setter and getter methods will be
     * added the the corresponding attribute
     * meta data
     *
     * @param pojo       class for which the setter and getter should be evaluated
     *                   according to their annotations
     * @param attributes list of attribute meta data for the generation (object
     *                   model)
     */
    ...
    /**
     * Extracts all information of the given annotations recursively and writes them
    ...
    /**
     * Determines whether the given attributes behaving as IDs on the persistence
     * layer. The information will be
     * integrated into the default model as stated in {@link #createModel(Class)}
     *
     * @param pojo       {@link Class} object of the POJO the data should be
     *                   retrieved from
