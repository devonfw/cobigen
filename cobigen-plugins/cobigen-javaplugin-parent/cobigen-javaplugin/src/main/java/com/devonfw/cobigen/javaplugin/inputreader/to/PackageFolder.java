...
public class PackageFolder {
   ...
   *
   * @param location {@link URI} to the package folder
  ...
  /**
   * Creates a new transfer object for a package with a {@link ClassLoader} for type resolution while parsing its
   * children.
   *
   * @param location {@link URI} to the package folder
   * @param packageName package name
   * @param classLoader for type resolution while parsing the package children
   */
  ...
  public String toString() {
    ...
    return "PackageFolder[packageName=" + this.packageName + ", location=" + this.location.toString() + "]";
  }
}
