...
public class JavaParserUtil {
   ...
   * <li><code>java.util.List&lt;java.lang.String&gt;</code> is converted into <code>List&lt;String&gt;</code></li>
   * </ul>
   *
   * @param canonicalType the String representation of the canonical type to be resolved
