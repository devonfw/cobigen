...
public class ReflectedJavaModelBuilderTest {
  ...
  public void testCorrectlyExtractedAttributeTypes() {
    ...
    assertThat(parametricTestAttributeModel).as("There is no field with name 'parametricTestAttribute' in the model")
        .isNotNull();
  ...
  public void testAnnotationExtractionOfSuperSuperTypes() {
    ...
    // getter
    assertThat(JavaModelUtil.getAnnotations(classField))
        .containsKey("com_devonfw_cobigen_javaplugin_unittest_inputreader_testdata_MySuperSuperTypeGetterAnnotation");
    // Setter
    assertThat(JavaModelUtil.getAnnotations(classField))
        .containsKey("com_devonfw_cobigen_javaplugin_unittest_inputreader_testdata_MySuperSuperTypeSetterAnnotation");
    // is-method
    assertThat(JavaModelUtil.getAnnotations(classField))
        .containsKey("com_devonfw_cobigen_javaplugin_unittest_inputreader_testdata_MySuperSuperTypeIsAnnotation");
    // attribute
    assertThat(JavaModelUtil.getAnnotations(classField))
        .containsKey("com_devonfw_cobigen_javaplugin_unittest_inputreader_testdata_MySuperSuperTypeFieldAnnotation");
    @SuppressWarnings("unchecked")
    Map<String, Object> annotation = (Map<String, Object>) JavaModelUtil.getAnnotations(classField)
