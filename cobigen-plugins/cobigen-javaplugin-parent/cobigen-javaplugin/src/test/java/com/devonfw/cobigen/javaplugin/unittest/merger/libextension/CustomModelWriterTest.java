...
public class CustomModelWriterTest {
  ...
  /**
   * Tests whether 'value=' is not written for annotation parameters, whereas value is the only parameter. See
   * https://github.com/devonfw/cobigen/issues/143
   *
   * @throws Exception test fails
   */
  @Test
  ...
  /**
   * Tests the output of the CustomModelWriter with respect to the syntax of the array notation for annotation parameter
  ...
  /**
   * Tests the output of the CustomModelWriter with respect to the syntax of the array notation for annotation parameter
   * values with only one Annotation.
   *
   * See https://github.com/devonfw/cobigen/issues/290
   *
   * @throws Exception test fails
  ...
  /**
   * Tests the output of the CustomModelWriter regarding the full qualified names of the nested annotations used in it.
   *
  ...
  /**
   * Tests the output of the CustomModelWriter regarding an own Annotation with multiple grouped annotations and the
