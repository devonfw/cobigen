...
public class OpenAPIInputReader implements InputReader {
  ...
  /**
   * Components retrieved from an EntityDef. Used for not executing multiple times the retrieval of components
   */
   ...
   *
   * @param schema schema to extract constraints from. Might be component property schema or parameter schema
      ...
      if (openApi.getSchema(key).getExtensions().get(Constants.COMPONENT_EXT) == null) {
        throw new InvalidConfigurationException(
            "Your Swagger file is not correctly formatted, it lacks of x-component tags.\n\n"
                ...
                + "to check how to correctly format it." + " If it is still not working, check your file indentation!");
      }
