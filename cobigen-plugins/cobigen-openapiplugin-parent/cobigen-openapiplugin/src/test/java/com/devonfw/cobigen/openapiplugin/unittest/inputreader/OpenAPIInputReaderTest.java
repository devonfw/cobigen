...
public class OpenAPIInputReaderTest {
  ...
  public void testRetrieveAllInputs() throws Exception {
    ...
    assertThat(inputObjects).extracting("name").containsExactly("Table", "Sale", "tablemanagement", "salemanagement");
  }
  ...
  public void testRetrieveOperationsOfPath() throws Exception {
    ...
    assertThat(operations).extracting("type").containsExactly("get", "post", "get", "get", "post", "get", "post", "get",
        "get", "post");
  }
  ...
  public void testRetrieveParametersOfOperation() throws Exception {
    ...
    assertThat(parameters).extracting("name").containsExactly("id", "table", "amount", "bla", "criteria", "id", "table",
        "amount", "bla", "criteria");
  ...
  /**
   * Not possible to properly test, see input file for example of the error to test (SomeData items schema is a
   * reference to FurtherData, parent of FurtherData is SomeData). See https://github.com/devonfw/cobigen/issues/578 for
   * more detail.
   */
  @Test
   ...
   *
   * @param o object to check whether it is an EntityDef
   ...
   *
   * @param o object to check whether it is an ComponentDef
