 ...
 */
public class CrudOpenapiAngularServiceBasedAppTest extends AbstractMavenTest {
  ...
  public static void setupDevTemplates() throws URISyntaxException, IOException {
    ...
    templatesProject = new File(
        CrudOpenapiAngularServiceBasedAppTest.class.getProtectionDomain().getCodeSource().getLocation().toURI())
