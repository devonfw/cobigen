...
export class ${variables.etoName?cap_first}GridComponent implements OnInit {
  ...
  <#list model.properties as property>
    { name: '${property.name}', label: this.getTranslation('${variables.component?lower_case}.${variables.etoName?cap_first}.columns.${property.name}') }<#if property?has_next>,</#if>
  </#list>
  ];
  ...
  searchTerms: any = {
  <#list model.properties as property>
    ${property.name}: null<#if property?has_next>,</#if>
  </#list>
  };
