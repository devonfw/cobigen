package com.devonfw.cobigen.templates.oasp4j.test.utils.uml;
...
import com.devonfw.cobigen.templates.oasp4j.utils.uml.Connector;
import com.devonfw.cobigen.templates.oasp4j.utils.uml.UmlUtil;
...
public class UmlUtilTest {
    ...
    public void beforeAll() throws Exception {
        ...
        xmlStringBuilder.append(FileUtils.readFileToString(
            new File("src/test/java/com/devonfw/cobigen/templates/oasp4j/test/utils/resources/uml/completeUmlXmi.xml"),
            "UTF-8"));
