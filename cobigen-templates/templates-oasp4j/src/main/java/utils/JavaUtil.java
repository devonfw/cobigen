...
public class JavaUtil {
   ...
   * @param annotation {@link String} the name of the annotation
   ...
   * @param pojoClass {@link Class}&lt;?> the class object of the pojo
   * @param name {@link String} the name of the method
   * @return the class name of the parameter annotated with {@link javax.ws.rs.PathParam} if one exists, otherwise "-"
   */
   ...
   *
   * @param doc {@link String} the javadoc you want to parse
   ...
   *
   * @param input {@link String} the string representation of a MediaType
