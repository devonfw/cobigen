 ...
 *
 */
public class CrudJavaServerAppFunctions {

  /**
   * The constructor.
   */
  public CrudJavaServerAppFunctions() {
...
/**
 * Determines the ID getter for a given 'field' dependent on whether the getter should access the ID via an object reference or a direct ID getter
...
/**
 * Determines the ID setter for a given 'field' dependent on whether the setter should access the ID via an object reference or a direct ID setter. 
 ...
 */
  public String resolveIdVariableName(Map<String, Object>field){
    // the component is passed down as an empty string since byObjectReference is false and therefore the component is never touched
