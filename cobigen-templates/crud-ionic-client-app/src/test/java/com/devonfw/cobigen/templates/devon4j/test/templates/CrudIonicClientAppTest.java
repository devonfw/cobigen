 ...
 */
public class CrudIonicClientAppTest extends AbstractMavenTest {
  ...
  public static void setupDevTemplates() throws URISyntaxException, IOException {
    ...
    templatesProject = new File(
        CrudIonicClientAppTest.class.getProtectionDomain().getCodeSource().getLocation().toURI()).getParentFile()
            .getParentFile().toPath();

    Path utilsPom = new File(CrudIonicClientAppTest.class.getProtectionDomain().getCodeSource().getLocation().toURI())
