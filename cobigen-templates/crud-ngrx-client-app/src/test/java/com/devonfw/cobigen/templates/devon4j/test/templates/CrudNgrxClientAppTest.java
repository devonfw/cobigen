 ...
 */
public class CrudNgrxClientAppTest extends AbstractMavenTest {
  ...
  public static void setupDevTemplates() throws URISyntaxException, IOException {
    ...
    templatesProject = new File(CrudNgrxClientAppTest.class.getProtectionDomain().getCodeSource().getLocation().toURI())
        .getParentFile().getParentFile().toPath();

    Path utilsPom = new File(CrudNgrxClientAppTest.class.getProtectionDomain().getCodeSource().getLocation().toURI())
