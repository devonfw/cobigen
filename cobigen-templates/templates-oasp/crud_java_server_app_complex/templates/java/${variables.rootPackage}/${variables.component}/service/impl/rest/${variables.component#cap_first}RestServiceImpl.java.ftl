...
public class ${variables.component?cap_first}RestServiceImpl {
  ...
  /**
  * Delegates to {@link UcFind${variables.entityName}#find${variables.entityName}}.
  *
  ...
  */
  ...
  /**
   * Delegates to {@link UcManage${variables.entityName}#create${variables.entityName}}.
   *
   * @param ${variables.entityName?lower_case} the {@link ${variables.entityName}Eto} to be created
  ...
  /**
   * Delegates to {@link UcManage${variables.entityName}#delete${variables.entityName}}.
   *
  ...
  /**
   * Delegates to {@link UcFind${variables.entityName}#find${variables.entityName}Etos}.
   *
