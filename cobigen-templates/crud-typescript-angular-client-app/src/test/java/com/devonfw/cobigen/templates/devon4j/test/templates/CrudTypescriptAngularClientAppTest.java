 ...
 */
public class CrudTypescriptAngularClientAppTest extends AbstractMavenTest {
  ...
  public static void setupDevTemplates() throws URISyntaxException, IOException {
    ...
    templatesProject = new File(
        CrudTypescriptAngularClientAppTest.class.getProtectionDomain().getCodeSource().getLocation().toURI())
  ...
  /**
   * Test successful generation of all templates based on a TypeScript entity
   *
   * @throws Exception test fails
   */
  @Test
  public void testAllTemplatesGeneration_TypescriptEntityInput() throws Exception {
