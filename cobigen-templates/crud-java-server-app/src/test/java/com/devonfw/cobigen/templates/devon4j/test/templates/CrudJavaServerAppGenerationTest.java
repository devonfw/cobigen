 ...
 */
public class CrudJavaServerAppGenerationTest extends AbstractMavenTest {
  ...
  public static void setupDevTemplates() throws URISyntaxException, IOException {
    ...
    templatesProject = new File(
        CrudJavaServerAppGenerationTest.class.getProtectionDomain().getCodeSource().getLocation().toURI())
