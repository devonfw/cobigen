 ...
 */
public class CrudJavaEaUmlTest extends AbstractMavenTest {
  ...
  public static void setupDevTemplates() throws URISyntaxException, IOException {
    ...
    templatesProject = new File(CrudJavaEaUmlTest.class.getProtectionDomain().getCodeSource().getLocation().toURI())
        .getParentFile().getParentFile().toPath();

    Path utilsPom = new File(CrudJavaEaUmlTest.class.getProtectionDomain().getCodeSource().getLocation().toURI())
