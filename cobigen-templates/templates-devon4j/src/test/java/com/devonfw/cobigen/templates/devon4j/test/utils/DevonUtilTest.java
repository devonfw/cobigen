...
public class DevonUtilTest {
    ...
    /**
     * Tests {@link DevonUtil#resolveIdVariableNameOrSetterGetterSuffix(Class,Map,boolean,boolean,String)}
     * <br/>
     * With
     * <ul>
    ...
    public void testResolveIdGetterEntitySameComponent() throws Exception {
        ...
        assertThat(new DevonUtil().resolveIdGetter(field, true, component))
            .isEqualTo("getTestEntityComponent().getId()");
    }

    /**
     * Tests {@link DevonUtil#resolveIdVariableNameOrSetterGetterSuffix(Class,String,boolean,boolean,String)}
     * <br/>
     * With
     * <ul>
     * <li>Class {@link TestClass}</li>
