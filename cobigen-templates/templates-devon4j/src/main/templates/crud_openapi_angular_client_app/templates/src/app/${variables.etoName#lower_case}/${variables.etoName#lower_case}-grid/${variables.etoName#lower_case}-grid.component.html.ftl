          ...
          <div class="filter-form-fields">
            ...
            <#list model.properties as property>
              <mat-form-field color="accent">
                <input matInput placeholder="${property.name?capitalize}" [(ngModel)]="searchTerms.${property.name?uncap_first}" name="${property.name}">
              </mat-form-field>
            </#list>
            </div>
            ...
            <#list model.properties as property>
              <mat-form-field color="accent">
                <input matInput placeholder="${property.name?capitalize}" [(ngModel)]="searchTerms.${property.name?uncap_first}" name="${property.name?uncap_first}">
              </mat-form-field>
            </#list>
            </div>
          </div>
