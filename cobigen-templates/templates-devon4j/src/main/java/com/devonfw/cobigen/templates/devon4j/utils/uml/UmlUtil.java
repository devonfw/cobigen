    ...
    public String generateText(boolean isImpl, boolean isOverride) {
        ...
        for (Connector connector : connectors) {
            ...
            if (multiplicity == null || multiplicity.equals("1")) {
                ...
                content += "{" + "\n\t\treturn this." + new DevonUtil().removePlural(connectedClassName.toLowerCase())
                    + "s;" + "\n\t}";
                content += "\n\n\t";
                if (isOverride) {
                    content += "@Override\n\t";
                ...
                content +=
                    "public void set" + new DevonUtil().removePlural(connectedClassName) + "s(List<" + connectedClassName
