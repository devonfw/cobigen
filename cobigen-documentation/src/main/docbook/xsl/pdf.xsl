...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
					...
					<fo:table-row>
						<fo:table-cell text-align="center">
							...
							<fo:block font-family="Helvetica" font-size="10pt" padding="5mm" padding-before="25em">
								<xsl:text>This documentation of GobiGen is subject to the terms and conditions of the Capgemini CobiGen License Agreement.</xsl:text>
							</fo:block>
	...
	<xsl:template name="footer.content">
		...
		This documentation of GobiGen is subject to the terms and conditions of the Capgemini CobiGen License Agreement.
		</xsl:variable>
