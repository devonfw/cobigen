package com.devonfw.poc.jwtsample.general.logic.base;
...
import com.devonfw.poc.jwtsample.general.common.base.AbstractBeanMapperSupport;
 ...
 * transfer objects.
	 ...
	 */
	protected <T extends Serializable, E extends PersistenceEntity<?>> Page<T> mapPaginatedEntityList(Page<E> page, Class<T> clazz) {
